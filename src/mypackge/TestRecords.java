 ...
 */
public class TestRecords extends javax.swing.JFrame {

    /**
     * Creates new form TestRecords
     */
    public TestRecords() {
        initComponents();
        getData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestRecords.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestRecords().setVisible(true);
            }
        });
    }
